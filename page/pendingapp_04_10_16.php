...
if($_SESSION['cat']=='SDO')
{
$checkrecord=$ob->get_recs("application","*","$fld='' and `elec_per`='Yes' and `fir_per`='Yes'   and `police_per`='Yes' and `polution_per`='Yes' and `finalize`='Yes'","");					
}
else if($_SESSION['cat']=='Police')
{
$checkrecord=$ob->get_recs("application","*","$fld='' and `elec_per`='Yes' and `finalize`='Yes'","");
...
{
$checkrecord=$ob->get_recs("application","*","","");	
			
}
else
{
$checkrecord=$ob->get_recs("application","*","$fld='' and `finalize`='Yes'","");
